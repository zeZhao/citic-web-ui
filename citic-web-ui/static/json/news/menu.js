...
export default [
    {
        ...
        children: [
            ...
            { lable: "云服务器(微软云)", url: "citic-web-ui/product/detail?supplierAlias=microsoft&serviceAlias=vm" },
            ...
            { lable: "块存储(中信专有云)", url: "citic-web-ui/product/detail?service_id=5959f3f5bf213c5770d9a32b" },
            { lable: "云磁盘(微软云)", url: "citic-web-ui/product/detail?supplierAlias=microsoft&serviceAlias=disk" },
            { lable: "对象存储OSS（阿里云）", url: "citic-web-ui/product/detail?service_id=57721cb62fa45f06e1c013d6" },
            { lable: "文件存储NAS（阿里云）", url: "citic-web-ui/product/detail?service_id=5a4d8ba12cc1c614e497e178" },
            ...
            { lable: "黑石-混合云Plus", url: "citic-web-ui/product/detail?service_id=201709271272072521" },
...

    {
        ...
        children: [
            ...
            { lable: "负载均衡SLB（金山云）", url: "citic-web-ui/product/detail?service_id=slbaba9bab2b7be3bf381243" },
            { lable: "弹性IP（阿里云）", url: "citic-web-ui/product/detail?service_id=58b3cc2618e1fb442d8f4077" },
            { lable: "弹性IP(微软云)", url: "citic-web-ui/product/detail?supplierAlias=microsoft&serviceAlias=IPservice" },
            ...
            { lable: "虚拟私有网络VPC（金山云）", url: "citic-web-ui/product/detail?service_id=vpcaba9bab2b7be3bf381243" },
            { lable: "共享带宽包（阿里云）", url: "citic-web-ui/product/detail?service_id=58f86433434fa917ce66a178" },
            ...
            { lable: "云安全防护(360云)", url: "citic-web-ui/product/detail?service_id=201711061628112233" },
...

    {
        title: "数据库",
        children: [
            { lable: "云数据库 MySql（阿里云）", url: "citic-web-ui/product/detail?service_id=5762107c6ae6ca04e14595b8" },
            { lable: "云数据库 MongoDB（阿里云）", url: "citic-web-ui/product/detail?service_id=59b1fb661a74d146c4fa7eb4" },
            { lable: "云数据库 MySql(金山云)", url: "citic-web-ui/product/detail?service_id=rds8e9a11fa6e6c4ab79b5df" },
            { lable: "云数据库 MySql(中信专有云)", url: "citic-web-ui/product/detail?service_id=5959f3f5bf213c5770d9a32c" },
            ...
            { lable: "云数据库 MySql只读（阿里云）", url: "citic-web-ui/product/detail?service_id=596ecb29027772050998969e" },
            { lable: "云数据库Redis（阿里云）", url: "citic-web-ui/product/detail?service_id=5785e232b9aa1e3769039c19" },
            { lable: "袋鼠云oracle数据库服务", url: "citic-web-ui/product/detail?service_id=201709251994734055" },
            {
                lable: "云数据库Oracle(中信专有云)",
                url: "citic-web-ui/product/detail?service_id=369fb62a-6341-4581-8ed0-b355f7c3093a"
            },
        ]
    },

    {
        title: "企业应用",
        children: [
            { lable: "财务管理", url: "citic-web-ui/product/detail?service_id=15085000078420607107" },
            { lable: "财务报表合并", url: "citic-web-ui/product/detail?service_id=201707270565691905" },
            ...
            { lable: "移动报账", url: "citic-web-ui/product/detail?service_id=a732806f-46c5-4386-9877-41c5687a5fbd" },
            { lable: "人力资源管理", url: "citic-web-ui/product/detail?service_id=20e7fd16-e5b0-46ec-bc8a-5a4a8232b313" },
            { lable: "民主测评服务（宏景云）", url: "citic-web-ui/product/detail?service_id=201711200953567810" },
            { lable: "项目管理", url: "citic-web-ui/product/detail?service_id=41fc31a4-d0d7-4a1a-a3a5-744b8cec72a6" },
            { lable: "采购管理", url: "citic-web-ui/product/detail?service_id=a732806f-46c5-4386-9877-41c5687a5fbc" },
            { lable: "企业邮箱", url: "citic-web-ui/product/detail?service_id=15085000078420607113" },
            { lable: "移动办公（道一）", url: "citic-web-ui/product/detail?service_id=15085000078420607130" },
            { lable: "协同办公", url: "citic-web-ui/product/detail?service_id=15085000078420607142" },
            { lable: "视频会议（派视）", url: "citic-web-ui/product/detail?service_id=15085000078420607229" },
            ...
            { lable: "云客服（逸创增强版）", url: "citic-web-ui/product/detail?service_id=201708011340342711" },
            { lable: "易企秀", url: "citic-web-ui/product/detail?service_id=201712211139843827" },
            ...
            { lable: "越亮传奇直播标准服务", url: "citic-web-ui/product/detail?service_id=201712211735524819" },
            { lable: "内容运营管理服务", url: "citic-web-ui/product/detail?service_id=201712141798667096" },
            ...
            { lable: "Saas版模板建站", url: "citic-web-ui/product/detail?service_id=fd0c9244-f1e6-49df-a18e-70ae7a1facbf" },
            { lable: "网络营销设计", url: "citic-web-ui/product/detail?service_id=f8b176f3-8191-489b-9abb-ea3ced517964" },
            { lable: "文档云", url: Util.getSystemLink().data + "DOCCloud.jsp" },
        ]
    },

    {
        title: "物联网",
        children: [
            { lable: "物联网桥接器", url: "https://iiot.c.citic/home/#hub" },
            { lable: "设备管理器", url: "https://iiot.c.citic/home/#dpm" },
            { lable: "数据智能分析", url: "https://iiot.c.citic/home/#analytics" },
            { lable: "物联网用户权限", url: "https://iiot.c.citic/home/#permission" },
            { lable: "即插即用服务开发", url: "https://iiot.c.citic/home/#pnp" },
            { lable: "物联网OpenAPI", url: "apistore/apidetail.html?service_id=9481cac3-12f3-4576-a047-596f0de6dc81" },
            { lable: "物联网平台SDK", url: "https://iiot.c.citic/home/#sdk" },
            { lable: "物联网应用", url: "https://iotapp.c.citic" }
        ]
    },

    {
        title: "大数据",
        children: [
            { lable: "大数据实施服务", url: "citic-web-ui/product/detail?service_id=201804090137360600" },
            {
                lable: "HDFS",
            ...
            {
                lable: "Kafka",
                url: "views/cloud/buy.jsp?serviceId=0cff6582-6bfb-4560-a170-5a5180e9b363&serviceTypeId=1"
            },
            { lable: "EMR", url: Util.getSystemLink().data + "EMR.jsp" },
            { lable: "大数据开发套件", url: Util.getSystemLink().data + "/bigData.jsp" },
    ...
    },
    {
        ...
        children: [
            {
                lable: "法律信息",
                url: "https://market.c.citic/views/goodsList/indexList.html?category=%E6%B3%95%E5%BE%8B%E4%BF%A1%E6%81%AF"
            },
            {
                lable: "企业信息",
                url: "https://market.c.citic/views/goodsList/indexList.html?category=%E4%BC%81%E4%B8%9A%E4%BF%A1%E6%81%AF"
            },
            {
                lable: "金融信息",
                url: "https://market.c.citic/views/goodsList/indexList.html?category=%E9%87%91%E8%9E%8D%E4%BF%A1%E6%81%AF"
            },
            {
                lable: "其他行业",
                url: "https://market.c.citic/views/goodsList/indexList.html?category=%E5%85%B6%E5%AE%83%E8%A1%8C%E4%B8%9A"
            },
        ]
    },
    {
...

    {
        ...
        children: [
            ...
            { lable: "天气查询（阿里）", url: "apistore/apidetail.html?service_id=10c8f1a5-2b07-4cc2-bf26-3a803bbb354e" },
            { lable: "中信企业年金API", url: "apistore/apidetail.html?service_id=925d3994-4075-43b3-a128-78db2843890a" },
            { lable: "中信云API", url: "apistore/apidetail.html?service_id=c3472270-671d-4897-af94-c67fcbb04722" },

            //{ lable: "地图服务（百度）", url: "apistore/apidetail.html?service_id=4b524916-3ca4-4c4b-8e5a-205e4224ce41" },
            { lable: "短信服务（阿里）", url: "apistore/apidetail.html?service_id=ef424d6a-ddf6-45d4-b9ee-b1086145928f0" },
            { lable: "国际短信服务（阿里）", url: "apistore/apidetail.html?service_id=bd25c684-f84b-49a3-8feb-fd88d692434c" },

            { lable: "数据库迁移", url: "citic-web-ui/product/detail?service_id=201705090817658591" },
            { lable: "服务器迁移", url: "citic-web-ui/product/detail?service_id=201705091587109265" },
            { lable: "用友NC定制服务", url: "citic-web-ui/product/detail?service_id=201706191420945665" },
            { lable: "天阳宏业报表合并定制服务", url: "citic-web-ui/product/detail?service_id=201707282050020570" },
            { lable: "天阳宏业全面预算定制服务", url: "citic-web-ui/product/detail?service_id=201707311496379762" },
            { lable: "腾讯企邮箱定制服务", url: "citic-web-ui/product/detail?service_id=201707180746210586" },
            { lable: "蓝凌OA定制服务", url: "citic-web-ui/product/detail?service_id=15085000078420607201" },
            //{ lable: "定制实施开发（Apicloud）", url: "citic-web-ui/product/detail?service_id=201804190760291561" },
            { lable: "APP应用交互设计", url: "citic-web-ui/product/detail?service_id=201804181680346242" },
            ...
            { lable: "设备托管服务", url: "citic-web-ui/product/detail?service_id=201709120608299958" },
            { lable: "联创智融信息化人天服务", url: "citic-web-ui/product/detail?service_id=201803260606043782" },
            { lable: "瑞友科技信息化人天服务", url: "citic-web-ui/product/detail?service_id=201803260957901957" },
            { lable: "考奇信息化人天服务", url: "citic-web-ui/product/detail?service_id=201803261812923832" },
            { lable: "高伟达信息化人天服务", url: "citic-web-ui/product/detail?service_id=201801241622004088" },
            { lable: "CV备份实施", url: "citic-web-ui/product/detail?service_id=201801301918461605" },
            ...
            { lable: "统一用户身份认证(即将上线)", url: "" },
            { lable: "中金支付(即将上线)", url: "" },
            { lable: "中信银行支付(即将上线)", url: "" },
        ]
    }
]
